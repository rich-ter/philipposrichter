...
const ContactOverview = () => {
  return (
    <div>
      <section class=" bg-white dark:bg-gray-900 lg:flex">
    <div class="flex flex-col justify-center w-full p-8 lg:bg-gray-100 lg:dark:bg-gray-800 lg:px-12 xl:px-32 lg:w-1/2">
        <h1 class="text-3xl font-semibold text-gray-800 capitalize dark:text-white lg:text-4xl">Let's speak.</h1>

        <p class="mt-4 text-gray-500 dark:text-gray-400">
            Collaborations, questions or just a casual chat, I would love to hear from you
        </p>

        <div class="mt-6 md:mt-8">
            <h3 class="font-medium text-gray-600 dark:text-gray-300 ">Connect with me</h3>
